...
OpenSpec documents capture architecture, feature, security, and Microsoft platform decisions for **SComm Office**: an Outlook-hosted SComm capability layer (Office.js add-in + Fastify server monorepo).
...
| [003-idr-transport](./architecture/003-idr-transport.md) | `@idrto/idr_browser_sdk` wrapper, CSP, `IdrTransport` interface |
...
| [pubkey-server-api](./features/pubkey-server-api.md) | Proposed PUT/GET; revoke state, not hard delete |
